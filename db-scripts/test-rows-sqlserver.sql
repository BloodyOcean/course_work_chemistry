...
VALUES (1, '2022-05-01', 'InProgress'),
(2, '2022-05-02', 'InProgress');
...
-- Insert test data into payments table
INSERT INTO shipping (order_id, delivery_date, carrier, receiver, tracking_number, shipping_address, shipping_city,
                          shipping_state, shipping_zip)
VALUES (1, '2023-05-15 10:00:00', 'FedEx', 'John Smith', '123456789', '123 Main St', 'Anytown', 'CA', '12345');
