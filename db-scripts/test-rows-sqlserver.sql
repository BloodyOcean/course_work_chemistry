...
INSERT INTO products (name, description, price, quantity, manufacturer_id, supplier_id, packaging_id, discount_id,
                      category_id)
...
INSERT INTO orders (customer_id, shipping_id, order_date, status)
VALUES (1, 1, '2022-05-01', 'InProgress'),
       (2, 1, '2022-05-02', 'InProgress');
